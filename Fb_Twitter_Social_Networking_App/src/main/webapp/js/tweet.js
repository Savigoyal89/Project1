...
(function(d, s, id) {
  ...
  if (d.getElementById(id)) return;
  js = d.createElement(s); js.id = id;
  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v5.0&appId=611986419357386";
  fjs.parentNode.insertBefore(js, fjs);
}(document, 'script', 'facebook-jssdk'));
...
function CreateTweetViaAjax(){
	var url = "https://project1web-275019.appspot.com/GaeDataStore?text_content=" + 
	...
	xmlhttp.onload = function() {
		if(xmlhttp.readyState === xmlhttp.DONE){
			...
			if(xmlhttp.status === 200){
				...
				var url = "https://apps.facebook.com/611986419357386/LinkedTweet?tweet_id=" + tweet_id;
				FB.ui({method:  'send',
					link:url });
			}
		}
